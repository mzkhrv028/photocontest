...
class GameSession(Base):
    ...
    round: Mapped[int | None] = mapped_column(default=None)
...
class User(Base):
    ...
    games: Mapped[list["Game"]] = relationship(init=False, secondary="sessions", back_populates="users")
...
class Game(Base):
    ...
    users: Mapped[list["User"]] = relationship(init=False, secondary="sessions", back_populates="games")
